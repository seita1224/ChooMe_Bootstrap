...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.example.seita.choome_mainproject";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "ChooMe";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.example.seita.choome_mainproject.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.example.seita.choome_mainproject.";
