...
* ChooMe is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as ChooMe is mean to act as a starting point for Android Applications.

# ChooMe App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-example-seita-choome_mainproject.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-example-seita-choome_mainproject)

This repository contains the source code for the [ChooMe](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.example.seita.choome_mainproject).

Please see the [issues](https://github.com.example.seita.choome_mainproject/com-example-seita-choome_mainproject/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about ChooMe? Ask away on the [com-example-seita-choome_mainproject discussion forum](https://groups.google.com/forum/#!forum/com-example-seita-choome_mainproject).

<a href="https://play.google.com/store/apps/details?id=com.example.seita.choome_mainproject" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.example.seita.choome_mainproject__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.example.seita.choome_mainproject__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.example.seita.choome_mainproject.R__) will now be renamed
...
signed with a different key.  Manually uninstall ChooMe from your device and
...
ChooMe is a result of a template project I've developed over the years as well as
...
ChooMe is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.example.seita.choome_mainproject/com-example-seita-choome_mainproject/contributors) on
...
[pull requests](https://github.com.example.seita.choome_mainproject/com-example-seita-choome_mainproject/pulls).
