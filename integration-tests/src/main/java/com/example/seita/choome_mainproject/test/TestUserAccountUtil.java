...
import static com.example.seita.choome_mainproject.core.Constants.Auth.*;

import com.example.seita.choome_mainproject.tests.R;
import com.example.seita.choome_mainproject.util.Ln;
